...
✅ **コメント返しは 2026-08-23 の実配信で通しました。** **チャットを開き直したときに過去のコメントへ一斉投稿しないこと**も実配信で確かめています (→ [どこまで確かめたか](#どこまで確かめたか))。
...
- **自由文 (`{msg}`) 入りの文面の通し確認** (003)。2026-08-23 の実配信で通した
- **コメント返しの通し確認** (004 / [specs/004-comment-link/tasks.md](specs/004-comment-link/tasks.md) T12)。
  登録者のコメントで投稿される・固定されない・同じ配信で 2 回目が出ない・
  自分の投稿を引き金に再投稿しない・**チャットを開き直したときに過去のコメントへ
  一斉投稿しない**、を実配信で確かめた
